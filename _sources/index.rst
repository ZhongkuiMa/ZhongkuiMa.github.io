...
- .. raw:: html
     ...
     <span class="rainbow-flash"> <i> Newest!!! </i> </span>
...
- [Nov. 2023]
  Our paper
  `ReLU Hull Approximation <https://popl24.sigplan.org/track/POPL-2024-popl-research-papers>`_
  is accepted by
  `the 51st ACM SIGPLAN Symposium on Principles of Programming Languages (POPL'24) <https://popl24.sigplan.org/>`_.
...
- [Nov. 2023]
  ...
  `Formalizing Robustness Against Character-Level Perturbations for Neural Network
  Language Models <https://link.springer.com/chapter/10.1007/978-981-99-7584-6_7>`_
  and my doctoral symposium paper,
